...
namespace ClassLibrary4
{
    ...
    public class Searching
    {
        ...
        {
            movies.Add(new Movie("Lifeisbeautifull", "Telugu", "Melody", 20));
            movies.Add(new Movie("Fear", "Telugu", "Thriller", 40));
            movies.Add(new Movie("abcdfg", "Telugu", "Drama", 50));
            movies.Add(new Movie("renu", "Telugu", "Thriller", 60));
            movies.Add(new Movie("vicky", "Kannada", "Drama", 34));
        }
        public void search()
        {
